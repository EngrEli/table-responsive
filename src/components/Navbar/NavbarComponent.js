...
import Logo from "../../assets/images/generic.png";
...
function NavbarComponent() {
  return (
    <Navbar
      ...
      expand="xl"
      variant="dark"
      className="navbar-sprout"
    >
      <Navbar.Brand href="#home">
        <Image src={Logo} className="company-logo" />
        Company Logo
      </Navbar.Brand>
        ...
        <Nav className="ms-auto">
          ...
          <Form className="search-form d-flex align-items-center">
            ...
            <FontAwesomeIcon
              ...
              className="navbar-sprout-icons"
              style={{ color: "#70787E", fontSize: "27px" }}
            />
          </Form>
          <NavItem className="d-none d-xl-flex">
            <FontAwesomeIcon
              icon={faBell}
              className="navbar-sprout-icons"
              style={{ color: "#70787E", fontSize: "25px" }}
            />
          </NavItem>
          <NavItem className="d-none d-xl-flex">
            <Image src={Profile} />
